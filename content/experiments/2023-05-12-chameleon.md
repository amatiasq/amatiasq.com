...
I asked ChatGPT to build "chameleon eye" effect eye where a set of green circles follow the mouse and it produced [this](/demos/chameleon.v1/).

Far from the objective but not so far, after a few iterations ([1](/demos/chameleon.circulo-azul/), [2](/demos/chameleon.blanco/)) I finally managed to reach it.
...
Y produjo [esto](/demos/chameleon.v1/).

Lejos del objetivo pero no demasiado, después de un par de iteracioens ([1](/demos/chameleon.circulo-azul/), [2](/demos/chameleon.blanco/)) finalmente lo conseguí.
