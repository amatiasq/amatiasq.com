...
<!-- TODO: https://prosopo.io/articles/typescript-branding/ -->
...
> Update February 2024: Branded types now has a simpler snippet to be used. [source](https://github.com/mckravchyk/comments/discussions/7#discussioncomment-8311846)
...
> Actualización Febrero 2024: Branded types ahora tiene un snippet sencillo para usarlos. [fuente](https://github.com/mckravchyk/comments/discussions/7#discussioncomment-8311846)
...
getUser(random as UserId); // funciona
```

(diapositivas solo disponible en inglés 🇬🇧)
